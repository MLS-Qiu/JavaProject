...
@WebServlet("/kennels/*")
public class KennelsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (action.equals("/kennels/cueList")) {
            req.getRequestDispatcher("/WEB-INF/jsp/customer/kenList.jsp").forward(req, resp);
        } else if (action.equals("/kennels/cusDelete")) {
            req.getRequestDispatcher("/WEB-INF/jsp/customer/kenList.jsp").forward(req, resp);
        } else if (action.equals("/kennels/cusInsert")) {
            ...
            req.getRequestDispatcher("/WEB-INF/jsp/customer/kenInsert.jsp").forward(req, resp);
        } else if (action.equals("/kennels/cusUpdate")) {
            ...
            req.getRequestDispatcher("/WEB-INF/jsp/customer/kenUpdate.jsp").forward(req, resp);
        } else if (action.equals("/kennels/cusSearch")) {
            req.getRequestDispatcher("/WEB-INF/jsp/customer/kenSearch.jsp").forward(req, resp);
        } else if (action.equals("/kennels/cusExcOut")) {
            doPost(req, resp);
        }
    ...
    private void insert() throws IOException {
        ...
        if (result) {
            resp.sendRedirect(req.getContextPath() + "/pet/main");
        } else {
            session.setAttribute("cus", csb);
