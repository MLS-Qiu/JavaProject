...
<head>
    ...
    <link rel="stylesheet" href="assets/pet/css/petSearch.css">
    <script src="assets/lib/jQuery/jquery-3.6.3.min.js"></script>
    <script>
        const jCtx = "${ctx}/";
        const error = "${error}"
    </script>
    <script src="assets/pet/js/petSearch.js"></script>
...
<div class="search">
    ...
    <form action="" method="post">
        ...
        <div class="clear level1">
            <div class="fl">
                <label>主人编号:</label>
                <input type="text" id="p_oId" placeholder="请输入宠物主人编号">
            </div>
            <div class="fl">
                <label>宠物种类:</label>
